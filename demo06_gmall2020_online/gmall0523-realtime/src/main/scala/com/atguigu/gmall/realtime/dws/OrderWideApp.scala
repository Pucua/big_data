...
/**
 * @author : Pucua
 * @date : 2023-10-13 21:01
 * @Desc : 从Kafka的DWD层读取订单和订单明细数据
 **/
object OrderWideApp {
  def main(args: Array[String]): Unit = {
    ...
    val orderWideDStream: DStream[(Long, (OrderInfo, OrderDetail))] = joinedDStream.mapPartitions {
      tupleItr => {
