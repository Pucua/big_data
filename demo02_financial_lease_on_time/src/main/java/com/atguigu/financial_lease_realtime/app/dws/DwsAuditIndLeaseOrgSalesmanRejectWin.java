...
import com.atguigu.financial_lease_realtime.bean.DwsAuditIndLeaseOrgSalesmanRejectBean;
...
public class DwsAuditIndLeaseOrgSalesmanRejectWin {
    public static void main(String[] args) throws Exception {
        ...
        // do 3.转换数据结构
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanRejectBean> rejectBeanStream = kafkaSource
                .map(new MapFunction<String, DwsAuditIndLeaseOrgSalesmanRejectBean>() {
                    @Override
        ...
        // do 4.添加水位线
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanRejectBean> withWaterMarkStream = rejectBeanStream
                .assignTimestampsAndWatermarks(WatermarkStrategy.<DwsAuditIndLeaseOrgSalesmanRejectBean>forBoundedOutOfOrderness(Duration.ofSeconds(5L))
...
//        reduceStream.print("reduce>>>");
        ...
        // do 9.写出到doris
        d1NameStream
                .map(new MapFunction<DwsAuditIndLeaseOrgSalesmanRejectBean, String>() {
                    @Override
