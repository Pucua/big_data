...
import com.atguigu.financial_lease_realtime.bean.DwsAuditAuditManRejectBean;
...
public class DwsAuditAuditManRejectWin {
    public static void main(String[] args) throws Exception {
        ...
        // TODO 4 引入水位线
        SingleOutputStreamOperator<DwsAuditAuditManRejectBean> withWaterMarkStream = beanStream
                .assignTimestampsAndWatermarks(WatermarkStrategy.<DwsAuditAuditManRejectBean>forBoundedOutOfOrderness(Duration.ofSeconds(5L))
        ...
        // TODO 7 聚合
        SingleOutputStreamOperator<DwsAuditAuditManRejectBean> reduceStream = windowStream
        ...
        // TODO 9 写出到doris
        dimStream
                .map(new MapFunction<DwsAuditAuditManRejectBean, String>() {
                    @Override
