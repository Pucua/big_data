...
import com.atguigu.financial_lease_realtime.bean.DwsAuditIndLeaseOrgSalesmanCancelBean;
...
public class DwsAuditIndLeaseOrgSalesmanCancelWin {
    public static void main(String[] args) throws Exception {
        ...
        // do 4.引入水位线
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanCancelBean> withWaterMarkStream = cancelBeanStream
                .assignTimestampsAndWatermarks(WatermarkStrategy.<DwsAuditIndLeaseOrgSalesmanCancelBean>forBoundedOutOfOrderness(Duration.ofSeconds(5L))
        ...
        // do 5.按照 业务方向 + 三级行业id + 业务经办员id 分组
        ...
        // do 7.聚合
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanCancelBean> reduceStream = windowStream
        ...
        // 8.6 关联一级部门id和二级部门名称
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanCancelBean> d1IdD2NameStream = AsyncDataStream.unorderedWait(d2IdD3NameStream, new AsyncDimFunctionHBase<DwsAuditIndLeaseOrgSalesmanCancelBean>() {
            @Override
            public String getTable() {
                return "dim_department";
            }
        ...
        // 8.7 关联一级部门名称
        SingleOutputStreamOperator<DwsAuditIndLeaseOrgSalesmanCancelBean> d1NameStream = AsyncDataStream.unorderedWait(d1IdD2NameStream, new AsyncDimFunctionHBase<DwsAuditIndLeaseOrgSalesmanCancelBean>() {
            @Override
            public String getTable() {
                return "dim_department";
            }
...
//        // do 9.写出数据到doris
//        d1NameStream
//                .map(new MapFunction<DwsAuditIndLeaseOrgSalesmanCancelBean, String>() {
//                    @Override
