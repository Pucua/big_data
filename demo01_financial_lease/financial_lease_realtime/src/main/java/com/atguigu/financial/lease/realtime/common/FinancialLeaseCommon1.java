package com.atguigu.financial.lease.realtime.common;

/**
 * @author yhm
 * @create 2023-08-18 17:40
 */
public class FinancialLeaseCommon1 {
    // Kafka ODS 层主题名称
    ...
    // HDFS URI
    public static String HDFS_URI_PREFIX = "hdfs://hadoop102:8020/financial_lease_realtime/ck/";
    // 操作 HDFS 的用户名
